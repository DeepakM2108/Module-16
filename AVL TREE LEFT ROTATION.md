...
## OUTPUT
<img width="1110" height="237" alt="image" src="https://github.com/user-attachments/assets/45542cd4-1c01-48ba-a187-5170450e9228" />
## RESULT
Thus,a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and insert the element '7' into it is executed successfully.
