...
## OUTPUT
<img width="1107" height="399" alt="image" src="https://github.com/user-attachments/assets/dd22a8f8-a4aa-4444-8b59-e7b1a233dadd" />

## RESULT
Thus,a Python function `def insert(self, k):` to insert the nodes in a **B-Tree** is successfully executed.
